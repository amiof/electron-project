...
const LinkIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon {...props} viewBox="0 0 64 64">
    <defs>
      {/* Search handle highlight */}
      <linearGradient id="color-1" x1="28.033" y1="14.915" x2="27.969" y2="38.468">
        <stop offset="0" stopColor="#95facc" />
        <stop offset="1" stopColor="#6ec8ff" />
      </linearGradient>
      
      {/* Magnifying glass rim highlight */}
      <linearGradient id="color-2" x1="38.016" y1="37.941" x2="44.612" y2="44.919">
        <stop offset="0" stopColor="#95facc" />
        <stop offset="1" stopColor="#6ec8ff" />
      </linearGradient>
      
      {/* Main globe + search icon */}
      <linearGradient id="color-3" x1="32.423" y1="6.83" x2="32.423" y2="51.872">
